...
- `NaN` MUST be rejected with `IndexCorruptionError` in all code paths — the key-index adapter wrapped comparator, lightweight clamping, and boundary validation.
